...
import org.example.base.ProductService;
...
public class SpringJdbcBatchPerfomanceApplication implements CommandLineRunner {
...
//    private ProductService simpleProductService;
    ...
    public static void main(String[] args) {
        SpringApplication.run(SpringJdbcBatchPerfomanceApplication.class, args);
    }
...
//            System.out.printf("Total gain: %d %s\n", calculateGainInPercent(regularElapsedTime, batchElapsedTime), "%");
    ...
    private int calculateGainInPercent(long before, long after) {
